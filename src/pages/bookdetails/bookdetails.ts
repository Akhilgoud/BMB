...
sendWhatsAppMsg() {
    if (this.bookObj && this.bookObj.bookContact[0] && this.bookObj.bookContact[0].phoneNo) {
        var phone = this.bookObj.bookContact[0].phoneNo;
        var msg = "Hi, '\n' <b>I am interested in buying this Book.</b> <br>";
        msg = msg + "Book Name:" + this.bookObj.name + '<br>';
        msg = msg + "Book Price:" + this.bookObj.price + '<br>';
        msg = msg + "Please let me know where and how can I collect it. <br>";
        msg = msg + "-Thanks";
