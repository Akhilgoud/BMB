...
export class LoginPage {
  ...
  sendReset(user) {
    ...
    this.socialSharing.shareViaEmail('Your new password is:' + user.password, 'BMB password request', [user.email]).then(() => {
      this.database.UpdateUser(user).then((data) => {
        console.log("user updated with new pass" + data);
